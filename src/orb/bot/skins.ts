...
export const COLORS: BotColor[] = [
  // Duya brand violet. Replaces the near-black `encre` of the reference
  // video: the orb is the duya mascot, so it wears the brand colour.
  { id: 'duya', hex: '#7c3aed' },
  { id: 'encre', hex: '#0a0a0c' },
  { id: 'brun', hex: '#8b5e3c' },
  { id: 'rouge', hex: '#e8483f' },
...
export const DEFAULT_COLOR = 'duya'
