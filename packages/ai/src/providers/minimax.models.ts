...
export const minimaxModels: Model<'anthropic'>[] = [
  {
    ...
    compat: { forceAdaptiveThinking: true, maxOutputTokens: 128000, allowEmptySignature: true },
    input: ['text', 'image'],
  ...
  },
  {
    ...
    reasoning: true,
    thinkingLevelMap: { off: null, low: 'low', medium: 'medium', high: 'high', max: 'max' },
    compat: { forceAdaptiveThinking: true, maxOutputTokens: 131072, allowEmptySignature: true },
    input: ['text', 'image'],
