 ...
 */
export const TEAMMATE_COMMAND_ENV_VAR = 'duya_TEAMMATE_COMMAND';
 ...
 */
export const TEAMMATE_COLOR_ENV_VAR = 'duya_AGENT_COLOR';
 ...
 */
export const PLAN_MODE_REQUIRED_ENV_VAR = 'duya_PLAN_MODE_REQUIRED';
