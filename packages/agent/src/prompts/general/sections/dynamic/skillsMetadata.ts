/**
 * General Agent Skills Metadata Section
 */
...
export const SKILLS_GUIDANCE = `After completing a complex task (5+ tool calls), fixing a tricky problem, or discovering a non-trivial workflow, save the approach as a skill with skill_manage so you can reuse it next time.
