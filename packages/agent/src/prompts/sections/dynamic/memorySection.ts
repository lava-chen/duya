/**
 * Memory Section - Persistent memory guidance for the agent.
 *
 * Combines the "what to save / how to write" framing from the general
 * agent's memory section with the "what NOT to save / limits" framing
 * from the shared runtime section. Both profiles render this verbatim
 * via `sections/dynamic/`.
 */
