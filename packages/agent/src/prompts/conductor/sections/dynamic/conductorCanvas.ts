/**
 * Conductor Agent ConductorCanvas Section
 * Dynamic canvas state injected into every conductor prompt
 */

import type { PromptContext } from '../../../types.js'
import type { ConductorCanvasSnapshot } from '../../../sections/dynamic/conductorCanvas.js'

export type { ConductorCanvasSnapshot } from '../../../sections/dynamic/conductorCanvas.js'
...
- Keep the canvas clean — delete obsolete elements only when asked
