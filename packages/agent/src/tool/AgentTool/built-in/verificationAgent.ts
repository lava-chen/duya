...
1. Read the project's README for build/test commands and conventions. Check package.json for script names.
...
- "I don't have a browser" — did you actually check for browser automation tools? If present, use them. If an MCP tool fails, troubleshoot (server running? selector right?).
...
- **Intentional**: does comments or commit message explain this as deliberate?
