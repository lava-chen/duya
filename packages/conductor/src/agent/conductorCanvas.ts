...
export interface ConductorCanvasSectionContext {
  enabledTools?: ReadonlySet<string> | Set<string>;
}
...
export function buildConductorCanvasSection(context: ConductorCanvasSectionContext): string | null {
...
export const getConductorCanvasSection = buildConductorCanvasSection;
