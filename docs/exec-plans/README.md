...
| [408b-nested-agents-md-loading](./active/408b-nested-agents-md-loading.md) | 嵌套目录 AGENTS.md 按需加载（plan 408 Phase 6 立项）：PostToolUse 触发 + 四阶段发现（子树 AGENTS.md / 条件 globs 规则）+ applyHookInjection 投递，cc-haha nested_memory 对齐 | P1 | Phase A-C ✅（nested-loader 9 单测 + loop 接线 2 测试通过）；D3 手动验证待办 |
